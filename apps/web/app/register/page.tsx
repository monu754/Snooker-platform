    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-zinc-900/80 backdrop-blur-xl border border-zinc-800 rounded-2xl shadow-2xl p-6 md:p-8 relative z-10">
        ...
        <form className="space-y-4" onSubmit={handleRegister}>
          ...
          <button type="submit" disabled={(!passwordsMatch && isConfirmDirty) || loading} className="w-full mt-2 bg-emerald-600 hover:bg-emerald-500 disabled:bg-zinc-700 disabled:text-zinc-400 text-white font-semibold rounded-lg px-4 py-3 transition-colors duration-200 cursor-pointer flex justify-center items-center">
        ...
        <button type="button" onClick={() => signIn("google", { callbackUrl: "/" })} className="mt-6 w-full flex items-center justify-center gap-3 bg-white text-zinc-900 font-semibold rounded-lg px-4 py-3 hover:bg-zinc-200 transition-colors duration-200 cursor-pointer">
